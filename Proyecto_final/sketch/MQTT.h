...
#define TXTOPIC       "/TX_CASA"         /* Nombre del topic de publicación */
#define RXTOPIC       "/RX_CASA"         /* Nombre del topic de suscripción */
#define RXTOPIC1      "/Casa"        /* Nombre del topic de suscripción */
...
void MQTT :: callback(char* topic, byte* message, unsigned int length) {
  ...
  ACTUADORES.control_luces(messageTemp);
}